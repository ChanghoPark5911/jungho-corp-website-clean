...
/**
 * ABOUT 메인 페이지 - Hybrid 버전
 * 6개의 아름다운 카드 그리드로 구성
 */
const AboutPageHybrid = () => {
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div variants={fadeInUp}>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-green-600 dark:text-green-400 mb-6">
          ...
          {/* 구분선 */}
          <motion.div 
            className="mt-12 w-24 h-1 bg-gradient-to-r from-green-600 to-cyan-500 mx-auto rounded-full"
            variants={fadeInUp}
          />
        </div>
      </motion.section>
...
export default AboutPageHybrid;
