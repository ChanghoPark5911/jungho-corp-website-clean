...
const AboutVisionPage = () => {
  ...
  const content = (
    <div>
      {/* Hero Section */}
      <motion.section 
        className="relative pt-32 pb-6 bg-gradient-to-br from-primary-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
        initial="hidden"
        animate="visible"
        variants={fadeInUp}
      >
      ...
      {/* IRGS 카드 */}
      <motion.section 
        className="pt-6 pb-12 bg-white dark:bg-gray-900"
        initial="hidden"
        animate="visible"
